...
void MRCC_vDisableClock(bus_type A_BusId , u8 A_u8PeripheralId)
{
	...
	{
	case RCC_AHB1 :
		CLEAR_BIT(RCC->AHB1ENR,A_u8PeripheralId);
		break ;
	case RCC_AHB2:
		CLEAR_BIT(RCC->AHB2ENR,A_u8PeripheralId);
		break ;
	case RCC_APB1 :
		CLEAR_BIT(RCC->APB1ENR,A_u8PeripheralId);
		break ;
	case RCC_APB2 :
		CLEAR_BIT(RCC->APB2ENR,A_u8PeripheralId);
		break;
	case RCC_AHB1LP :
		CLEAR_BIT(RCC->AHB1LPENR,A_u8PeripheralId);
		break ;
	case RCC_AHB2LP :
		CLEAR_BIT(RCC->AHB2LPENR,A_u8PeripheralId);
		break ;
	case RCC_APB1LP :
		CLEAR_BIT(RCC->APB1LPENR,A_u8PeripheralId);
		break;
	case RCC_APB2LP :
		CLEAR_BIT(RCC->APB2LPENR,A_u8PeripheralId);
		break;
