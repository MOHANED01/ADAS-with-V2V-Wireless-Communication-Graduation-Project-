...
#define UART_DIV_SAMPLING16(PCLK, BAUDRATE)            ((u32)((((u64)(PCLK))*25U)/(4U*((u64)(BAUDRATE)))))
#define UART_DIVMANT_SAMPLING16(PCLK, BAUDRATE)        (UART_DIV_SAMPLING16((PCLK), (BAUDRATE))/100U)
#define UART_DIVFRAQ_SAMPLING16(PCLK, BAUDRATE)        ((((UART_DIV_SAMPLING16((PCLK), (BAUDRATE)) - (UART_DIVMANT_SAMPLING16((PCLK), (BAUDRATE)) * 100U)) * 16U) + 50U) / 100U)
/* UART BRR = mantissa + overflow + fraction
            = (UART DIVMANT << 4) + (UART DIVFRAQ & 0xF0) + (UART DIVFRAQ & 0x0FU) */
#define UART_BRR_SAMPLING16(PCLK, BAUDRATE)            ((UART_DIVMANT_SAMPLING16((PCLK), (BAUDRATE)) << 4U) + \
                                                        (UART_DIVFRAQ_SAMPLING16((PCLK), (BAUDRATE)) & 0xF0U) + \
                                                        (UART_DIVFRAQ_SAMPLING16((PCLK), (BAUDRATE)) & 0x0FU))

#define UART_DIV_SAMPLING8(PCLK, BAUDRATE)             ((u32)((((u64)(PCLK))*25U)/(2U*((u64)(BAUDRATE)))))
#define UART_DIVMANT_SAMPLING8(PCLK, BAUDRATE)         (UART_DIV_SAMPLING8((PCLK), (BAUDRATE))/100U)
#define UART_DIVFRAQ_SAMPLING8(PCLK, BAUDRATE)         ((((UART_DIV_SAMPLING8((PCLK), (BAUDRATE)) - (UART_DIVMANT_SAMPLING8((PCLK), (BAUDRATE)) * 100U)) * 8U) + 50U) / 100U)
/* UART BRR = mantissa + overflow + fraction
            = (UART DIVMANT << 4) + ((UART DIVFRAQ & 0xF8) << 1) + (UART DIVFRAQ & 0x07U) */
#define UART_BRR_SAMPLING8(PCLK, BAUDRATE)             ((UART_DIVMANT_SAMPLING8((PCLK), (BAUDRATE)) << 4U) + \
                                                        ((UART_DIVFRAQ_SAMPLING8((PCLK), (BAUDRATE)) & 0xF8U) << 1U) + \
                                                        (UART_DIVFRAQ_SAMPLING8((PCLK), (BAUDRATE)) & 0x07U))
