		...
		u8 A_u8OutType )
{
	if(A_u8OutType== GPIO_OUTPUTTYPE_PUSHPULL )
	{
		...
		{
		case GPIO_PORTA :
			CLEAR_BIT(GPIOA->OTYPER,A_u8PinNo);
			break;
		case GPIO_PORTB:
			CLEAR_BIT(GPIOB->OTYPER,A_u8PinNo);
			break;
		case GPIO_PORTC:
			CLEAR_BIT(GPIOC->OTYPER,A_u8PinNo);
			break;
		}
	}
		...
		u8 A_u8PinVal )
{
	...
	else if (A_u8PinVal==GPIO_LOW)
	{
		...
		{
		case GPIO_PORTA :
			CLEAR_BIT(GPIOA->ODR,A_u8PinNo);
			break;
		case GPIO_PORTB:
			CLEAR_BIT(GPIOB->ODR,A_u8PinNo);
			break;
		case GPIO_PORTC:
			CLEAR_BIT(GPIOC->ODR,A_u8PinNo);
			break;
		}
	}
}
